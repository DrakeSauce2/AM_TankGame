...
public class SelectionScreen : MonoBehaviour
{
    ...
    private void SelectVehicle(SelectionVehicle selection)
    {
        ...
        spawnObjs = selection.InstantiateAmmunitionSlots(vehicleSlotAmmunitionAttachPoint);

        spawnedVehicleAmmunitionSlots = spawnObjs;
    ...
    private void DeselectVehicle()
    {
        ...
        spawnedVehicleAmmunitionSlots.Clear();
    }
